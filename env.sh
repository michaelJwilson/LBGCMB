...
export  LBGCMB=/home/mjwilson/LBGCMB/
...
export  PYTHONPATH=$LBGCMB/dropouts/reddy/:$PYTHONPATH
...
export  PYTHONPATH=$LBGCMB/dropouts/mqw/py:$PYTHONPATH
...
export  DESI_BASIS_TEMPLATES=$LBGCMB/desihub/basis_templates/v2.5/
