...
def get_dropoutbz(m=24.5):
    ...
    if m == 24.5:
      return  interp1d(data[:-1,0], data[:-1,1], kind='quadratic', bounds_error=False, fill_value='extrapolate')

    elif m == 25.0:
      return  interp1d(data[:,0], data[:,2], kind='cubic', bounds_error=False, fill_value='extrapolate')

    elif m == 25.5:
      return  interp1d(data[:-1,0], data[:-1,3], kind='quadratic', bounds_error=False, fill_value='extrapolate')  
