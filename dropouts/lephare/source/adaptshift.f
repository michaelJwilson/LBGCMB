...
c
c      integer*4 imag,imax,imin,nf,i,j,k,nobj,nobjm
...
c         if (typl.eq.0)                    nlib = 3
c         if (typl.gt.1000)                 nlib = 2
c         if (typl.ge.1 .and. model.le.999) nlib = 1
c   rejected models 
