...
pl.xlabel(r'$L$', fontsize=10)
pl.ylabel(r'$L \cdot C_{\kappa \kappa}$', fontsize=10)

pl.xlim(50.,    4.e3)
pl.ylim(1.e-7, 1.e-4)

pl.legend(ncol=3, handlelength=.75, loc=2, handletextpad=0.6, frameon=False, fontsize=10)
