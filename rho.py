...
from    prep_pmh           import  init_PmhPhh
...
from    ss17_biasz         import  load_samples
...
if __name__ == '__main__':
    ...
    for index, row in df.iterrows():
        ...
        print  row['Surveys'], zmin, zmax, nbar
        ...
        ckg     =  Ckg(Pk_interps, Llls, zmin, zmax, pz, zeff=True)
        cgg     =  Cgg(Pk_interps, Llls, zmin, zmax, pz, zeff=True)
