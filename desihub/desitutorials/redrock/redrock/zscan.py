...
def calc_zchi2_targets(redshifts, targets, template, verbose=False):
    ...
    for i, z in enumerate(redshifts):
        ...
        #- if all targets have the same number of spectra with the same wavelength grids, we only need to calculate this once per redshift.
        ...
        for j in range(ntargets):
            ...
            print("Template type: %s and redshift: %.3lf; chi2: %.4le" % (template.type, z, zchi2[j,i]))
