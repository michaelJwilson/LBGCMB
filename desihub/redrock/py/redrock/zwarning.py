...
class ZWarningMask(object):
    ...
    NEGATIVE_EMISSION = 2**6  #- a QSO line exhibits negative emission, triggered only in QSO spectra, if C_IV, C_III, Mg_II, H_beta, 
                              # or H_alpha has LINEAREA + 3 * LINEAREA_ERR < 0
