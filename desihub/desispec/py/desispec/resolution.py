...
# The total number of diagonals that we keep in the sparse formats when converting from a dense matrix
default_ndiag = 21
...
class Resolution(scipy.sparse.dia_matrix):
    ...
    Options:
        offsets: list of diagonals that the data represents.  
                 Only used if data is a 2D dense array.
